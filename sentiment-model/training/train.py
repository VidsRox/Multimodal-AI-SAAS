...
os.environ['LD_LIBRARY_PATH'] = (
    f"{sys.exec_prefix}/lib/python{sys.version_info.major}.{sys.version_info.minor}/"
    f"site-packages/nvidia/cudnn/lib:"
    f"{sys.exec_prefix}/lib/python{sys.version_info.major}.{sys.version_info.minor}/"
    f"site-packages/nvidia/cublas/lib:"
...
def main():
    ...
    print("Audio backends available:")
    ...
    if torch.cuda.is_available():
        ...
        print(json.dumps({
                "metrics": [
                    {"Name": "testn:loss", "Value": test_loss["total"]},
