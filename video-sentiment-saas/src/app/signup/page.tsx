                ...
                <div className="w-full max-w-md space-y-8 px-4">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            Sign up to get started with Sentiment 
                        </p>
                    </div>
                    ...
                    >
                            ...
                            <div>
                                <label className="text-sm font-medium text-gray-700">
                                    ...
                                    <input 
                                        ...
                                        border-gray-300 px-3 py-2 text-sm placeholder-gray-400 
                        ...
                        bg-gray-800 px-4 py-2 text-sm font-medium text-white
                        ...
                        <p className="text-center text-sm text-gray-600">
                            Already have an account?<Link className="font-medium text-gray-800 text-gray-700" href="/login"> Sign In</Link>
                        </p>
                    </form>
                </div>
            </main>
